function basicAttack(d)
	...
	d.CONTROL.AbilityCooldown:Invoke("Q", .625)
end
...
function ability1(d)
	...
	d.CONTROL.AbilityCooldown:Invoke("A", 3.5)
end
...
function ability2(d)
	...
	d.CONTROL.AbilityCooldown:Invoke("B", 4.5)
end
...
function ability3(d)
	...
	d.CONTROL.AbilityCooldown:Invoke("C", 6)
end
