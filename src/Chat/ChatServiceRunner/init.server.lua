...
ChatService:RegisterProcessCommandsFunction("default_commands", function(fromSpeaker, message, channel)
	...
	elseif (string.sub(message, 1, 3) == "/e " or string.sub(message, 1, 7) == "/emote ") then
		...
		elseif (string.sub(message, 1, 4) == "/tix" or string.sub(message, 1, 9) == "/permbuff" or string.sub(message, 1, 14) == "/forceidentity" or string.sub(message, 1, 4) == "/exp" or string.sub(message, 1, 5) == "/kick" or string.sub(message, 1, 4) == "/ban" or string.sub(message, 1, 10) == "/antitouch" or string.sub(message, 1, 5) == "/meep" or string.sub(message, 1, 4) == "/meh" or string.sub(message, 1, 8) == "/showinv" or string.sub(message, 1, 8) == "/banbyid" or string.sub(message, 1, 3) == "/ff") then return true
