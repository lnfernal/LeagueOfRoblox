...
function ability4(d)
	...
	local minion = game.ServerStorage.ClanMinion:clone()
...
local abilityData = {
	...
	B = {
		...
		Desc = "ClanAtlas dashes <range> studs forward. Afterwards, slows him by <slow>% for <duration> seconds after using it.",
		MaxLevel = 5,
		range = {
			Base = 25,
			AbilityLevel = 3,
	...
	C = {
		Name = "Regenerate",
		Desc = "ClanAtlas casts a regenerative spell at a targeted area, healing allies within for <heal> health and instantly granting them <buff> health as a shield for <duration> seconds. The heal is increased by 50%, grants defenses instead of a shield, and the buff duration is increased by 100% on minions,",
		MaxLevel = 5,
		heal = {
			Base = 10,
			AbilityLevel = 6,
	...
	D = {
		Name = "Clan",
		Desc = "ClanAtlas summons an allied minion with <health> health and deals <miniondamage> damage on hit in an explosion at the targeted point, dealing <damage> damage and slows 30% to enemies caught for 1.25 seconds.",
		MaxLevel = 3,
		damage = {
			Base = 25, 
			AbilityLevel = 15,
