...
function basicAttack(d)
	...
	local hrp = d.HRP
	if basicSpin then
		d.PLAY_ANIM(d.PLAYER, "http://www.roblox.com/DeadpoolBasicAttack1Final-item?id=615179269")
		d.PLAY_SOUND(d.HUMAN, 83674171, nil, 1.2)
	else
		d.PLAY_ANIM(d.PLAYER, "http://www.roblox.com/DeadpoolBasicAttack2Final-item?id=615178282")
...
function ability1(d)
	...
	d.PLAY_ANIM(d.PLAYER, "http://www.roblox.com/DeadpoolFrenziedStrikeFInal-item?id=615180419")
...
function ability2(d)
	...
	d.SFX.Circles:Invoke(topos, 5,Colors,.2,dir)
	end
	local function onEnd(p)
		d.HRP.CFrame = p:CFrame()
		
		d.PLAY_ANIM(d.PLAYER, "http://www.roblox.com/DeadpoolCycloneDash-Contact-Final-item?id=615179269")
		d.PLAY_SOUND(d.HUMAN, 83674171, nil, 1.2)
		...
		d.SFX.Shockwave:Invoke(d.FLAT(center), radius, Colors)
	end
...
function ability3(d)
	...
	d.SFX.RisingForce:Invoke(d.HRP, Vector3.new(0, -2.5, 0), 8, 16, {BrickColor = d.C( Colors[math.random(1,#Colors)])}, 0.3)
...
function ability4(d)
	...
	d.PLAY_ANIM(d.PLAYER, "http://www.roblox.com/DeadpoolAnnihilateFinal-item?id=615178282")
	...
	local p = d.DS.AddProjectile:Invoke(position, direction, speed, width, range, team, onHit, onStep, onEnd)
	d.SFX.ProjShrink:Invoke(p:ClientArgs(), 2.25, Colors, 0.5)
	end
