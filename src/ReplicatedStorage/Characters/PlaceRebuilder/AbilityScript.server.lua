...
local abilityData = {
	...
	D = {
		Name = "Cheers!",
		Desc = "After being rescued, PlaceRebuilder will always make sure the zombies will never forget him. PlaceRebuilder shines his teeth which fires a beam in a straight line that deals <damage> damage and slows them by <slow>% for 2 seconds. Hitting an enemy with Radiation will heal you <damage> health.",
		MaxLevel = 3,
		damage = {
			Base = 20,
			AbilityLevel = 5,
