...
function ability3(d)
	...
	local function onEnd(projectile)
		...
		d.SFX.Artillery:Invoke(projectile.Position, 4, d.CHAR.Torso.Skills.Value.Color)
	end
...
function ability4(d)
	...
	d.CONTROL.AbilityCooldown:Invoke("D", 70) --Changed cooldown from 52.5 to 75 Seconds
wait(0.15)
	...
	d.SFX.Shockwave:Invoke(center, radius, d.CHAR.Torso.Skills.Value.Color)
	d.SFX.Explosion:Invoke(center, radius / 2,d.CHAR.Torso.Skills.Value.Color)
end
