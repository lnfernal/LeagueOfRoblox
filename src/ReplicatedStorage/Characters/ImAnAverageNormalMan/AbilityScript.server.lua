...
if currentcombos[1] == "punch" and currentcombos[2] == "punch" and currentcombos[3] == "uppercut" then
	combo = {}
	currentcombos = {}
	initializeStackGui()
	return "stun"
end	
if currentcombos[1] == "punch" and currentcombos[2] == "kick" and currentcombos[3] == "uppercut" then
	combo = {}
	currentcombos = {}
	initializeStackGui()
	return"dance"
end	
if currentcombos[1] == "slide" and currentcombos[2] == "uppercut" and currentcombos[3] == "kick" then	
	combo = {}
	currentcombos = {}
	initializeStackGui()
	return "double"
end	
if currentcombos[1] == "slide" and currentcombos[2] == "punch"and currentcombos[3] == "kick"and currentcombos[4] == "uppercut"and currentcombos[5] == "punch"and currentcombos[6] == "punch"then
	combo = {}
	currentcombos = {}
	initializeStackGui()
	return "all"	
...
function basicAttack(d)
	...
	record("punch")
	local tocheck = check()
	d.PLAY_ANIM(d.PLAYER, "https://www.roblox.com/ImAnAverageBasic-item?id=566124803")
	...
	d.SFX.Shockwave:Invoke(center, rangeb,d.CHAR.Torso.Kick.Value.Color)
...
function ability1(d)
	...
	if d.CHAR.Torso:FindFirstChild("GenderbendStudent") and d.CHAR.Torso:FindFirstChild("GenderbendStudent").Value == true then
		d.SFX.Explosion:Invoke(d.CHAR.Torso.Position, 6, d.CHAR.Torso.Slide.Value.Color)
		d.CHAR.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=503022328"
		d.CHAR.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=503022480"
		d.CHAR.Hair.Mesh.TextureId = "rbxassetid://503025106"
		d.CHAR.Extensions.Mesh.TextureId = "rbxassetid://503025136"
	end
	...
	d.DS.AddProjectile:Invoke(position, direction, speed2, width, range, team, onHit, onStep, onEnd)
end
...
function ability2(d)
	...
	local tocheck = check()
	if d.CHAR.Torso:FindFirstChild("GenderbendStudent") and d.CHAR.Torso:FindFirstChild("GenderbendStudent").Value == true then
		d.SFX.Explosion:Invoke(d.CHAR.Torso.Position, 6, d.CHAR.Torso.Kick.Value.Color)
		d.CHAR.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=498145142"
		d.CHAR.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=498147961"
		d.CHAR.Hair.Mesh.TextureId = "rbxassetid://439733756"
		d.CHAR.Extensions.Mesh.TextureId = "rbxassetid://167549869"
	end
	local function PickRandomEffect()
		local Values = {1, 3}
		return Values[math.random(1, #Values)]
...
function ability3(d)
	...
	local tocheck = check()
	if d.CHAR.Torso:FindFirstChild("GenderbendStudent") and d.CHAR.Torso:FindFirstChild("GenderbendStudent").Value == true then
		d.SFX.Explosion:Invoke(d.CHAR.Torso.Position, 6, d.CHAR.Torso.Uppercut.Value.Color)
		d.CHAR.Shirt.ShirtTemplate = "http://www.roblox.com/asset/?id=503022294"
		d.CHAR.Pants.PantsTemplate = "http://www.roblox.com/asset/?id=503022424"
		d.CHAR.Hair.Mesh.TextureId = "rbxassetid://503025065"
		d.CHAR.Extensions.Mesh.TextureId = "rbxassetid://503025032"
	end
	local function PickRandomEffect()
		local Values = {1, 2}
		return Values[math.random(1, #Values)]
