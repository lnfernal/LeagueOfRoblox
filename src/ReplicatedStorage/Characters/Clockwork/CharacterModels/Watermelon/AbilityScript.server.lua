...
local abilityData = {
	A = {
		Name = "Watermelon Rain",
		Desc = "Clockwork drops a watermelon from the sky, dealing <damage> damage in a small area after a short delay.",
		MaxLevel = 5,
		damage = {
			Base = 15,
			AbilityLevel = 5,
