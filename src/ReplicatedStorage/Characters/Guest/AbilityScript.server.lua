...
function ability1(d)
	...
	d.SFX.RisingForce:Invoke(d.HRP, Vector3.new(0, -2.5, 0), 8, 16, {BrickColor = d.C(("Really black"))}, 0.3)
	wait(0.3)
	d.SFX.Shockwave:Invoke(d.FLAT(d.HRP.Position), 8, "Really black")
...
function ability3(d)
	...
	d.SFX.RisingForce:Invoke(d.HRP, Vector3.new(0, -2.5, 0), 4, 32, {BrickColor = d.C("Black")}, 0.25)
end
...
function ability4(d)
	...
	local function onHit(projectile, enemy)
		d.SFX.Artillery:Invoke(d.FLAT(projectile.Position), 4, "Really black")
	...
	d.SFX.ProjShrink:Invoke(p:ClientArgs(), 3, "Black", 0.4)
end
