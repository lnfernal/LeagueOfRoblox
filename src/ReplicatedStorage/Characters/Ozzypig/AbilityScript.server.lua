...
function ability2(d)
	...
	d.CONTROL.AbilityCooldownLag:Invoke("D", 1)
	...
	d.CHAR.Hat.Mesh.Scale = Vector3.new(6, 7, 6)
	...
	wait(1)
	d.CHAR.Hat.Mesh.Scale = Vector3.new(1, 1, 1)
...
function ability4(d)
	...
	if hitSomeone then
		d.CONTROL.AbilityCooldownReduce:Invoke("D", 10 - (39.16 * d.CONTROL.GetStat:Invoke("CooldownReduction")))
	end	
...
local abilityData = {
	...
	D = {
		Name = "Hi There!",
		Desc = "Ozzypig blinks to a target location and gains <buff> H4x for <duration> seconds. If an enemy is near where he appears, the cooldown of this ability is reduced by 10 seconds.",
		MaxLevel = 3,
		buff = {
			AbilityLevel = 10,
			H4x = 0.3,
