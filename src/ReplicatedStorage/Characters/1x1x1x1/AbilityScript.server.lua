...
function basicAttack(d)
	...
	d.PLAY_ANIM(d.PLAYER, "http://www.roblox.com/1x1x1x1BasicAttackFinal-item?id=261281654")
	...
	part.Shape = "Ball"
	part.Transparency = 0.5 * math.random()
	part.BrickColor = BrickColor.new(color(2, d))
	...
	d.SFX.ProjShrink:Invoke(p:ClientArgs(), 1, color(2, d), 0.1)
end
...
function ability1(d)
	...
	d.SFX.Trail:Invoke(d.CHAR.Orb, Vector3.new(), 1.25, {BrickColor = d.C(color(2, d))}, 0.5, 0.45)
	wait(0.6)
	...
	d.SFX.ProjShrink:Invoke(p:ClientArgs(), 2, color(2, d), 0.5)
...
function ability4(d)
	...
	d.SFX.Artillery:Invoke(d.HRP.Position, 10, "Earth green")
    d.ST.MoveSpeed:Invoke(d.HUMAN, -.7, 1.25)
    d.PLAY_ANIM(d.PLAYER, "http://www.roblox.com/1x1x1x1UnbannableFinal-item?id=261283155")
	...
	wait(1.25)
	d.SFX.ReverseExplosion:Invoke (d.HRP.Position,8, "Lime green")
	...
	wait (.5)
	local sparkles = d.CHAR:FindFirstChild("UnbannableSparkles", true)
