function basicAttack(d)
	...
	d.SFX.ProjZap:Invoke(p:ClientArgs(), 0.25, d.CHAR.Torso.Basic.Value.Color, 0.1)
...
wait(0.2)
	...
	for theta = -spread, spread, spread do
		...
		d.SFX.ProjZap:Invoke(p:ClientArgs(), 0.45, d.CHAR.Torso.Basic.Value.Color, 0.1)
			d.SFX.ProjTrail:Invoke(p:ClientArgs(), 0.2,d.CHAR.Torso.Basic.Value.Color, 0.25,direction,"Neon",0.039)
	end
