...
function basicAttack(d)
	...
	elseif attackNumber == 3 then
		...
		knife.BrickColor = BrickColor.new("Brown")
		knife.Material = "Wood"
...
function ability1(d)
	...
	d.CONTROL.AbilityCooldown:Invoke("A", 5 - (5 * d.CONTROL.GetStat:Invoke("CooldownReduction")))
	wait(0.15)
...
function ability2(d)
	...
	d.CONTROL.AbilityCooldown:Invoke("B", 6 - (6 * d.CONTROL.GetStat:Invoke("CooldownReduction")))
...
function ability3(d)
	...
	d.CONTROL.AbilityCooldown:Invoke("C", 8 - (8 * d.CONTROL.GetStat:Invoke("CooldownReduction")))
	wait(0.15)
...
function ability4(d)
	...
	local arena = game.ServerStorage.NoobArena
	local position = d.HRP.Position
...
local abilityData = {
	A = {
		Name = "Trip",
		Desc = "Noob trips and tries to get up but he spins, dealing <damage> damage to nearby enemies".."\"".."Sorry!".."\"",
		MaxLevel = 7,
		damage = {
			Base = 25,
			AbilityLevel = 7.5,
	...
	B = {
		Name = "OH GOD A BUG",
		Desc = "Noob sees a bug and tries to hit it with his stick hitting enemies in front, dealing <damage> damage to enemies in front of him and slowing them by 30% for 2 seconds.".."\"".."It was a accident I swear!".."\"",
		MaxLevel = 5,
		damage = {
			Base = 20,
			AbilityLevel = 8,
	...
	C = {
		Name = "Lunge",
		Desc = "Noob charges forward, dealing <damage> damage to enemies caught in his path.".."\"".."IM SO SORRY!".."\"",
		MaxLevel = 5,
		damage = {
			Base = 30,
			AbilityLevel = 9,
	...
	D = {
		Name = "Arena",
		Desc = "Noob feels scared and traps himself in a arena for <duration> seconds. While Noob is in his arena, he gains 10% increased Attackspeed Reduction.",
		MaxLevel = 1,
		duration = {
			Base = 6,
