...
sparkles.Color = Color3.new(0,255,0)
...
function ability1(d)
	...
	wait(.1)
	circles = circles + 1
	d.SFX.Circles:Invoke(topos, 1,"Lime green",.2,dir)
	until circles == 6
end
...
function ability2(d)
	...
	d.SFX.Artillery:Invoke(center, 2, script.Parent.Parent.Character.Torso.Skills.Value.Color, 0.75)
	wait(0.75)
