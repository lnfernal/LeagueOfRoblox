...
mesh.MeshId = "http://www.roblox.com/asset/?id=62294054"
mesh.TextureId = "http://www.roblox.com/asset/?id=62294115"
...
local abilityData = {
	...
	C = {
		Name = "Battlecry",
		Desc = "Khanovich lets out a battle roar, dealing <damage> damage and stunning nearby enemies for anywhere from 1 to 1.5 seconds. The radius of this ability is <radius> studs.",
		MaxLevel = 5,
		radius = {
			Base = 13,
			AbilityLevel = 0.75
