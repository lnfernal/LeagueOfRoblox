...
mesh.MeshId = "http://www.roblox.com/asset/?id=73820141"
mesh.TextureId = "http://www.roblox.com/asset/?id=73820205"
...
function ability2(d)
	...
	local function onHit(p, enemy)
		...
		if hrp then
			d.DS.Damage:Invoke(enemy, damage, "Toughness", d.PLAYER)
			d.SFX.Artillery:Invoke(d.FLAT(hrp.Position), 8, "Really red")
...
function ability3(d)
	...
	d.SFX.Explosion:Invoke(center, radius, "Deep orange")
end
...
local abilityData = {
	...
	C = {
		Name = "Evil Laughter!",
		Desc = "Khanovich laughs at his enemies, dealing <damage> damage and stunning nearby enemies for anywhere from 1 to 1.5 seconds. The radius of this ability is <radius> studs.",
		MaxLevel = 5,
		radius = {
			Base = 13,
			AbilityLevel = 0.75
