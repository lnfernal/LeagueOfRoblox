...
local abilityData = {
	...
	B = {
		...
		Desc = "Davidii spins in a circle, dealing <damage> damage to targets around him. If he hits a non-player target, he heals himself for either <heal2> (based on level) or <heal> (based on maximum health), based on the bigger value. If he hits a player, the damage is multiplied by 1.5x and he will leave his enemies debilitated, weakening their movement speed by 0.75% per 1% of their missing health for 2 seconds.",
		MaxLevel = 9,
		damage = {
			Base = 15,
			AbilityLevel = 10,
	...
	D = {
		...
		Desc = "If Davidii drops below <baseline> health, this ability is activated. He gains <duration> seconds of invincibility, gains 15% missing health as health regen over 3 seconds.",
		MaxLevel = 3,
		duration = {
			Base = 2.5,
			AbilityLevel = .25,
