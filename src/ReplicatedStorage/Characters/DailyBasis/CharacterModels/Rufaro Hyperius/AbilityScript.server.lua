function basicAttack(d)
	...
	d.DS.Melee:Invoke(hrp, team, onHit,10,5) 
end
...
function ability1(d)
	...
	d.PLAY_ANIM(d.PLAYER, "http://www.roblox.com/DailyShieldDashFinal-item?id=525722112")
...
local abilityData = {
	...
	B = {
		Name = "King of Bronze",
		Desc = "DailyBasis creates a magical field <range> studs in radius which grants his allies a moment of invincibility. Enemies who are nearby will be slowed by 25% for 3 seconds.",
		MaxLevel = 5,
		range = {
			Base = 12,
			AbilityLevel = 1,
	...
	C = {
		Name = "Shield Bash",
		Desc = "DailyBasis bashes with his shield. He deals <damage> damage as a melee attack and stuns the target for <duration> seconds. Also, he permanently gains 1 Toughness. The bonus is halfed on non-players.",
		MaxLevel = 5,
		damage = {
			Base = 40,
			AbilityLevel = 15,
	...
	D = {
		Name = "Bell of Bronze",
		Desc = "DailyBasis creates a sound wave with his shield. It travels straight forward, rooting enemies it hits for <duration> seconds.",
		MaxLevel = 3,
		duration = {
			Base = 1.05,
			AbilityLevel = 0.4,
