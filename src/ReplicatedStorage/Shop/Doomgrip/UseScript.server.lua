...
function script.Use.OnInvoke(item, d)
	...
	local team = d.CHAR.Team.Value
		...
		d.ST.StatBuff:Invoke(ally, "Skillz", d.CONTROL.GetStat:Invoke("Skillz") * .15, 5)
		d.ST.StatBuff:Invoke(ally, "H4x", d.CONTROL.GetStat:Invoke("Skillz") * .15, 5)
		end
	d.DS.AOE:Invoke(d.FOOT(), radius, d.GET_OTHER_TEAM:Invoke(d.CHAR.Team.Value),onHit)
	d.SFX.Artillery:Invoke(d.FOOT(), radius, "Bright red")	
		active = false
		wait(30)
		active = true
end